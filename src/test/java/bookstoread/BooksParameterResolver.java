...
class BooksParameterResolver implements ParameterResolver {
    ...
    public Object resolveParameter(final ParameterContext parameterContext,
        ...
        books.put("The Mythical Man-Month", new Book("The Mythical Man- Month", "Frederick Phillips Brooks", LocalDate.of(1975, Month.
                JANUARY, 1)));
        ...
        books.put("Refactoring: Improving the Design of Existing Code", new
                Book("Refactoring: Improving the Design of Existing Code", "Martin Fowler", LocalDate.of(2002, Month.MARCH, 9)));
        return books;
    }
}
